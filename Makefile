...
# opdev.io/simple-demo-operator-bundle:$VERSION and opdev.io/simple-demo-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= quay.io/opdev/simple-demo-operator
...
digestpintool: ## Download envtest-setup locally if necessary.
	$(call go-get-tool,$(DIGESTPINTOOL),github.com/opdev/pin-deploy-imgs-in-csv@0.0.1)
